    ...
    for (eps in eps_values) {
        for (n_bins in bins_values) {
            ...
            for (m in 1:M) {
                ...
                mise_original = integrate(function(x) (dbeta(x, 10, 10) - d_hist(x, original_hist))^2, 0, 1, subdivisions = 2000)$value
    
                # calculate mise perturbed
                mise_perturbed = integrate(function(x) (dbeta(x, 10, 10) - d_hist(x, perturbed_hist))^2, 0, 1, subdivisions = 2000)$value
