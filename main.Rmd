...
This function plots a line plot with three lines:
* mean of the original MISE
* mean of the merturbed MISE
* mean of the MISE difference
```{r}
...
## Run Simulation
We will run the simulation with the same parameters for $n$, $\epsilon$ and $m$ and for the same number of times $M$. We also have $\pi$ as an additional parameter.
...
subset_and_plot = function(mise_data) {
...
subset_and_plot(pi_025)
subset_and_plot(pi_05)
subset_and_plot(pi_075)
